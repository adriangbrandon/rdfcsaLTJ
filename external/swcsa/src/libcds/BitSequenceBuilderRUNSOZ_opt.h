...
#ifndef BITSEQUENCEBUILDERRUNSOZ_OPT_H
#define BITSEQUENCEBUILDERRUNSOZ_OPT_H
...
namespace cds_static
{
	 ...
	 */
	class BitSequenceBuilderRUNSOZ_opt : public BitSequenceBuilder
	{
		public:

			BitSequenceBuilderRUNSOZ_opt();
			
			virtual ~BitSequenceBuilderRUNSOZ_opt();
