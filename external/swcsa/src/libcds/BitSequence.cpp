...
namespace cds_static
{
	...
	BitSequence * BitSequence::load(ifstream & fp) {
		...
		switch(r) {
			case DELTA_HDR: return BitSequenceDelta::load(fp);
			case RRR02_HDR: return BitSequenceRRR::load(fp);
			case BRW32_HDR: return BitSequenceRG::load(fp);
			case RGK02_HDR: return BitSequenceRGK::load(fp);
...
//@@			case DARRAY_HDR: return BitSequenceDArray::load(fp);
			case RUNSOZ_HDR: return BitSequenceRUNSOZ::load(fp);
			case RUNSOZ_HDR_OPT: return BitSequenceRUNSOZ_opt::load(fp);
