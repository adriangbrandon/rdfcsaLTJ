...
//	prepareToDecodeWithTables(&diffsHT); //using decoding-tables: did not improve :(
...
//	/**/	size_t ptr2 = ptr; uint huffmanCode2;//2023-
		
		ptr = decodeHuff(&cPsi->diffsHT,&huffmanCode,cPsi->stream,ptr);

//		ptr2 = decodeHuffTables(&cPsi->diffsHT,&huffmanCode2,cPsi->stream,ptr2); //2023-
//		
//	/**/	if (ptr != ptr2) {
//	/**/		printf("\n getHuffmanPsiR3Value - decode ptr differentes: %zu != %zu\n",ptr,ptr2);			
//	/**/	}
//	/**/
//	/**/	if (huffmanCode != huffmanCode2) {
//	/**/		printf("\n getHuffmanPsiR3Value - decode value differentes: %u != %u\n",huffmanCode,huffmanCode2);			
//	/**/	}
