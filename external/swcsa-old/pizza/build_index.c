 ...
 *
 * build_index.c: Main program to build a  word-based compressed data structure
 * defined as followed in "interface.h".
 *
 * This program is linked with the implementation of such data structure (wcsa.a)
 * and the building-program is created.
 * It loads the source text, creates the self-index and saves it to disk.
 *
