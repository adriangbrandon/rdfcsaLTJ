...
#define RRR02_HDR 2                 //RRR
#define BRW32_HDR 3                 //RG
#define RGK02_HDR 31                //RGK ... R. Know (Sequential search on samples for select)
#define RRR02_LIGHT_HDR 4
#define SDARRAY_HDR 5               //SDARRAY
#define DARRAY_HDR 6       
#define DELTA_HDR 7                 //DELTA 

#define RUNSOZ_HDR 10               // O-Z-BITMAP. sparse?
#define RUNSOZ_HDR_OPT 11               // O-Z-BITMAP. sparse?
