...
#ifndef BITSEQUENCEBUILDERRUNSOZ_H
#define BITSEQUENCEBUILDERRUNSOZ_H
...
namespace cds_static
{
	 ...
	 */
	class BitSequenceBuilderRUNSOZ : public BitSequenceBuilder
	{
		public:

			BitSequenceBuilderRUNSOZ();
			BitSequenceBuilderRUNSOZ(unsigned char bs_type);
			BitSequenceBuilderRUNSOZ(unsigned char bs_type, unsigned int sample_rate);
			
			virtual ~BitSequenceBuilderRUNSOZ();
